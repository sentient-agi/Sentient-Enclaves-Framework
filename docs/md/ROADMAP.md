...
- **0.10.0** - cryptography stack, for buffer level SLC and content encryption.

- **0.11.0** - integration with KMS for key storage, probably TPM module usage for local key storage.

- **0.12.0** - Advanced logging and log tracing for Pipeline and proxies. Web-RA already included structural logging.
