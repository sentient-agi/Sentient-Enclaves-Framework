...
deploy_net_components() {
    ./pipeline-dir send-dir ./pf-proxy/ /apps/pf-proxy/ 2>&1 ;
    ./pipeline run --port $port --cid $cid --command "chmod -v +x -R ./pf-proxy/*" ;
    ...
    ./pipeline send-file --port $port --cid $cid --localpath ./bin/speedtest --remotepath ./speedtest ;
    ./pipeline run --port $port --cid $cid --command "chmod -v +x ./speedtest" ;

    ./pipeline send-file --port $port --cid $cid --localpath ./bin/rclone --remotepath ./rclone ;
    ./pipeline run --port $port --cid $cid --command "chmod -v +x ./rclone" ;

    ./pipeline send-file --port $port --cid $cid --localpath ./bin/s5cmd --remotepath ./s5cmd ;
    ./pipeline run --port $port --cid $cid --command "chmod -v +x ./s5cmd" ;

    ./pipeline-dir send-dir ./root/ /app/ 2>&1 ;

    ./pipeline send-file --port $port --cid $cid --localpath ./sh/download.list --remotepath ./download.list ;
    ./pipeline send-file --port $port --cid $cid --localpath ./sh/wget.sh --remotepath ./wget.sh ;
