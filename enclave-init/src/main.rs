...
/// Map of active log streamers per service
...
fn main() {
    ...
    // Initialize streamer map for log streaming
    ...
    loop {
        ...
        // Periodically cleanup inactive streamers
        {
            let mut streamers_guard = streamers.lock().unwrap();
